...
module.exports.handleEvent = async function({ api, event, Currencies, Users, getText }) {
  ...
  var id1 = event.senderID;
    ...
    var background = [
  "https://i.imgur.com/1bP47jK.jpg",
  "https://i.imgur.com/LhvSGtx.jpg",
  "https://i.imgur.com/3kgVQPT.jpg",   "https://i.imgur.com/vqHqjES.jpg",
  "https://i.imgur.com/9VMeIoA.jpg",
  "https://i.imgur.com/mENHH6U.jpg",
  ...
  fs.writeFileSync(pathImg, Buffer.from(getbackground, "utf-8"));
    ...
    ctx.drawImage(baseAvt1, 41, 220, 300, 300);
...
module.exports.languages = {
	...
	"en": {
		...
		"levelup": "{name}, আপনার চ্যাটিং লেভেল {level}",
	}
}
